...
function preload(){
  ...
  resbalon=loadSound("Q7XGNSJ-cartoon-slip-sound.mp3")
  
  gameOverImg = loadImage("images/gameOver.png");
  crash=loadSound("001082006_prev.mp3")
  
  bananaImg=loadImage("—Pngtree—yellow banana peel hand drawn_4671091.png")
  
  explosionImg=loadImage("kisspng-cloud-computing-dust-5ab8efeb65bbc1.3974471915220694834167.png")
}
...
//establece el colisionador para el mainCyclist
  ...
  mainCyclist.setCollider("circle", 0, 0, 580)
...
redCG = new Group();
  ...
  explosion=createSprite(110,10, 10, 10);
...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    if(bananaCG.isTouching(mainCyclist)){
      gameState = END;
      banana.velocityY = 0;
      resbalon.play();
    }
    ...
    bananaCG.setVelocityXEach(0);
    bananaCG.setLifetimeEach(-1);
